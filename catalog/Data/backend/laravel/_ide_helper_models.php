 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre filter($input = [], $filter = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre paginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre simplePaginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre whereBeginsWith($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre whereEndsWith($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Genre whereLike($column, $value, $boolean = 'and')
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category filter($input = [], $filter = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category newQuery()
 * @method static \Illuminate\Database\Query\Builder|\App\Models\Category onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category paginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category simplePaginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereBeginsWith($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereEndsWith($column, $value, $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereLike($column, $value, $boolean = 'and')
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember filter($input = [], $filter = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember paginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember simplePaginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember whereBeginsWith($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember whereEndsWith($column, $value, $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\CastMember whereLike($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereBannerFile($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereThumbFile($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereTitle($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereTrailerFile($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Video whereVideoFile($value)
